...
//修改对象
func (table *CockroachTable) Change(item Map, data Map) (Map) {
	table.base.lastError = nil
...
//删除对象
// func (table *CockroachTable) Remove(items ...Map) int64 {
// 	table.base.lastError = nil
...
//恢复对象
// func (table *CockroachTable) Recover(items ...Map) (int64) {
// 	table.base.lastError = nil
...
func (table *CockroachTable) Remove(args ...Any) (Map) {
	table.base.lastError = nil
...
//批量删除，这可是真删
func (table *CockroachTable) Delete(args ...Any) (int64) {
	table.base.lastError = nil
...
func (table *CockroachTable) Update(update Map, args ...Any) (int64) {
	table.base.lastError = nil
